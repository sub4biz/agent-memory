...
The migration cost is minimal — see xref:how-to/migrate-to-providers.adoc[Migrate to Pluggable Providers] for side-by-side examples — and the warning fires exactly once per `MemoryClient` construction.
