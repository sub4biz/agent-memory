...
== Pass-through your Agents model (v0.3+)
...
Equivalent to `MemorySettings(llm="openai/gpt-4o-mini")` — the helper is for parity with the other integration packages' pass-through API. See xref:how-to/migrate-to-v0.3.adoc[Migrate to v0.3 — Pattern 5].
