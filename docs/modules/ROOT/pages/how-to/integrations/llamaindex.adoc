...
== Pass-through your LlamaIndex LLM (v0.3+)
...
The shared introspector reads `llm.model` and detects `anthropic` from the class module path. For the equivalent pattern across other integrations see xref:how-to/migrate-to-v0.3.adoc[Migrate to v0.3 — Pattern 5].
