...
== Pass-through your PydanticAI model (v0.3+)
...
For the equivalent pattern across other integrations, see xref:how-to/migrate-to-v0.3.adoc[Migrate to v0.3 — Pattern 5].
